...
function EventAssistant:OnEnable()
	...
	EventAssistantMainFrame:SetTitle("Event Assistant")
	EventAssistantMainFrame:SetPortraitToAsset(MAIN_ICON)
	...
	function refreshWindowUI()
		...
		EventAssistantMainFrame.guildName:SetText("Guild Name: " .. guildName);
	end
